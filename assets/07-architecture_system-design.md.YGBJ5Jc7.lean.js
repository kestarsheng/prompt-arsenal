...
## 迭代记录
- 1.0.0 (2026-09-03): 初始版本
- 2.0.0 (2026-09-17): 按新模板重构，去除 emoji，增加"需求不足先列问题""组件引入需触发条件""只讲优点不讲代价"等架构师约束`;let l=null;async function c(){try{await navigator.clipboard.writeText(d)}catch{const e=document.createElement("textarea");e.value=d,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e)}r.value=!0,clearTimeout(l),l=setTimeout(()=>{r.value=!1},1500)}return(e,a)=>(o(),i("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1789745195569"},[t("div",h,[t("button",{onClick:a[0]||(a[0]=q=>n.value=!n.value),style:{padding:"6px 14px",background:"var(--vp-c-brand)",color:"white",border:"none","border-radius":"4px",cursor:"pointer","font-size":"13px","font-weight":"500","box-shadow":"0 2px 8px rgba(0,0,0,0.15)",transition:"all 0.2s ease"}},s(n.value?"📖 返回阅读":"📄 源码"),1),t("button",{onClick:c,style:{padding:"6px 14px",background:"var(--vp-c-brand)",color:"white",border:"none","border-radius":"4px",cursor:"pointer","font-size":"13px","font-weight":"500","box-shadow":"0 2px 8px rgba(0,0,0,0.15)",transition:"all 0.2s ease"}},s(r.value?"已复制":"复制提示词"),1)]),n.value?(o(),i("div",g,[t("pre",b,[t("code",f,s(u(m)),1)])])):(o(),i("div",v,[...a[1]||(a[1]=[x("",22)])]))]))}});export{w as __pageData,S as default};
