...
- 1.0.0 (2026-09-03): 初始版本
- 1.1.0 (2026-09-04): 改为中英双语标题格式，正文改用中文列表
- 2.0.0 (2026-09-17): 按新模板重构，补充 scope 省略规则、"只输出提交信息本身"与防虚构约束`;let l=null;async function c(){try{await navigator.clipboard.writeText(d)}catch{const e=document.createElement("textarea");e.value=d,document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e)}o.value=!0,clearTimeout(l),l=setTimeout(()=>{o.value=!1},1500)}return(e,n)=>(i(),r("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1789745341171"},[t("div",x,[t("button",{onClick:n[0]||(n[0]=w=>a.value=!a.value),style:{padding:"6px 14px",background:"var(--vp-c-brand)",color:"white",border:"none","border-radius":"4px",cursor:"pointer","font-size":"13px","font-weight":"500","box-shadow":"0 2px 8px rgba(0,0,0,0.15)",transition:"all 0.2s ease"}},s(a.value?"📖 返回阅读":"📄 源码"),1),t("button",{onClick:c,style:{padding:"6px 14px",background:"var(--vp-c-brand)",color:"white",border:"none","border-radius":"4px",cursor:"pointer","font-size":"13px","font-weight":"500","box-shadow":"0 2px 8px rgba(0,0,0,0.15)",transition:"all 0.2s ease"}},s(o.value?"已复制":"复制提示词"),1)]),a.value?(i(),r("div",g,[t("pre",m,[t("code",b,s(f(u)),1)])])):(i(),r("div",v,[...n[1]||(n[1]=[h("",19)])]))]))}});export{P as __pageData,q as default};
