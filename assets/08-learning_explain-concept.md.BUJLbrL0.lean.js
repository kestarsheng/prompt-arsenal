...
## 迭代记录
- 1.0.0 (2026-09-03): 初始版本
- 2.0.0 (2026-09-17): 按新模板重构，增加"类比须指出失效点""禁止术语循环""禁止编造"约束，输出顺序固定`;let d=null;async function c(){try{await navigator.clipboard.writeText(p)}catch{const n=document.createElement("textarea");n.value=p,document.body.appendChild(n),n.select(),document.execCommand("copy"),document.body.removeChild(n)}o.value=!0,clearTimeout(d),d=setTimeout(()=>{o.value=!1},1500)}return(n,a)=>(l(),r("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1789745195569"},[e("div",h,[e("button",{onClick:a[0]||(a[0]=k=>t.value=!t.value),style:{padding:"6px 14px",background:"var(--vp-c-brand)",color:"white",border:"none","border-radius":"4px",cursor:"pointer","font-size":"13px","font-weight":"500","box-shadow":"0 2px 8px rgba(0,0,0,0.15)",transition:"all 0.2s ease"}},i(t.value?"📖 返回阅读":"📄 源码"),1),e("button",{onClick:c,style:{padding:"6px 14px",background:"var(--vp-c-brand)",color:"white",border:"none","border-radius":"4px",cursor:"pointer","font-size":"13px","font-weight":"500","box-shadow":"0 2px 8px rgba(0,0,0,0.15)",transition:"all 0.2s ease"}},i(o.value?"已复制":"复制提示词"),1)]),t.value?(l(),r("div",v,[e("pre",b,[e("code",f,i(x(u)),1)])])):(l(),r("div",y,[...a[1]||(a[1]=[g("",23)])]))]))}});export{w as __pageData,q as default};
