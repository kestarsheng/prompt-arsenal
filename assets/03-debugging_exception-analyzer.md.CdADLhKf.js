...
`,l={style:{position:"sticky",top:"80px",float:"right","z-index":"100","margin-bottom":"12px","margin-left":"12px"}},c={key:0,style:{background:"#1e1e1e",color:"#d4d4d4",padding:"24px","border-radius":"8px","max-height":"80vh",overflow:"auto",margin:"20px 0",border:"1px solid #333",clear:"both","font-family":"'Fira Code', monospace","font-size":"14px","line-height":"1.7","white-space":"pre-wrap","word-wrap":"break-word"}},g={style:{margin:"0","white-space":"pre-wrap","word-wrap":"break-word"}},u={style:{"font-family":"inherit","font-size":"14px",color:"#d4d4d4"}},h={key:1},_=JSON.parse('{"title":"异常堆栈分析与排查","description":"","frontmatter":{},"headers":[],"relativePath":"03-debugging/exception-analyzer.md","filePath":"03-debugging/exception-analyzer.md"}'),x={name:"03-debugging/exception-analyzer.md"},v=Object.assign(x,{setup(b){const e=s(!1);return(f,o)=>(r(),t("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1788675645000"},[n("div",l,[n("button",{onClick:o[0]||(o[0]=m=>e.value=!e.value),style:{padding:"6px 14px",background:"var(--vp-c-brand)",color:"white",border:"none","border-radius":"4px",cursor:"pointer","font-size":"13px","font-weight":"500","box-shadow":"0 2px 8px rgba(0,0,0,0.15)",transition:"all 0.2s ease"}},a(e.value?"📖 返回阅读":"📄 源码"),1)]),e.value?(r(),t("div",c,[n("pre",g,[n("code",u,a(i(p)),1)])])):(r(),t("div",h,[...o[1]||(o[1]=[d(`<hr><h2 id="tags-debugging-exception-error-version-1-0-0last-updated-2026-09-03" tabindex="-1">tags: [debugging, exception, error] version: 1.0.0 last_updated: 2026-09-03 <a class="header-anchor" href="#tags-debugging-exception-error-version-1-0-0last-updated-2026-09-03" aria-label="Permalink to &quot;tags: [debugging, exception, error]
version: 1.0.0
last_updated: 2026-09-03&quot;">​</a></h2><h1 id="异常堆栈分析与排查" tabindex="-1">异常堆栈分析与排查 <a class="header-anchor" href="#异常堆栈分析与排查" aria-label="Permalink to &quot;异常堆栈分析与排查&quot;">​</a></h1><h2 id="适用场景" tabindex="-1">适用场景 <a class="header-anchor" href="#适用场景" aria-label="Permalink to &quot;适用场景&quot;">​</a></h2><p>遇到异常堆栈时，想快速定位问题根因并找到解决方案。</p><h2 id="提示词模板" tabindex="-1">提示词模板 <a class="header-anchor" href="#提示词模板" aria-label="Permalink to &quot;提示词模板&quot;">​</a></h2><p>我遇到了以下异常，请帮我分析根因并给出修复方案： [粘贴完整的异常堆栈]</p><p><strong>相关代码：</strong> [粘贴相关代码片段]</p><p><strong>分析要求：</strong></p><ol><li>指出异常发生的准确位置（类、方法、行号）</li><li>分析异常的根本原因（不是表面现象）</li><li>判断是代码 Bug、配置问题还是环境问题</li><li>给出至少两种修复方案，并推荐最优方案</li><li>如果涉及第三方库，说明版本兼容性注意事项</li></ol><h2 id="使用示例" tabindex="-1">使用示例 <a class="header-anchor" href="#使用示例" aria-label="Permalink to &quot;使用示例&quot;">​</a></h2><p><strong>输入：</strong> [NullPointerException 堆栈 + 相关代码]</p><p><strong>AI输出：</strong> （输出异常分析报告）</p>`,13)])]))]))}});export{_ as __pageData,v as default};
